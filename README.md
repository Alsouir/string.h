...
Необходимо реализовать описанные ниже функции библиотеки string.h, функцию sprintf из библиотеки stdio.h, некоторые функции обработки строк из класса String : 
